...
<html lang="en">
								...
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										...
										<ul class="list-group border-bottom">
											<li class="list-group-item"><span class='fa fa-leaf'></span>Currently in Treatment<span class="badge badge-info"><?php echo $f8['total']?></span></li>
	...
	$conn = new mysqli('localhost', 'root', '', 'thesis') or die(mysqli_error());
										...
										?>
										<ul class="list-group border-bottom">
											<li class="list-group-item"><span class='fa fa-stethoscope'></span>Bacteriologically Confirmed<span class="badge badge-info"><?php echo $f1['total']?></span></li>
											<li class="list-group-item"><span class='fa fa-search'></span>Clinically Diagnosed<span class="badge badge-info"><?php echo $f2['total']?></span></li>
										</ul>                                
									</div>
								</div>
							</div>
	...
	$conn = new mysqli('localhost', 'root', '', 'thesis') or die(mysqli_error());
										...
										?>
										<ul class="list-group border-bottom">
											<li class="list-group-item"><span class='fa fa-star'></span>New<span class="badge badge-info"><?php echo $f1['total']?></span></li>
											<li class="list-group-item"><span class='fa fa-refresh'></span>Relapse<span class="badge badge-info"><?php echo $f2['total']?></span></li>
											<li class="list-group-item"><span class='fa fa-meh-o'></span>TALF<span class="badge badge-info"><?php echo $f3['total']?></span></li>
											<li class="list-group-item"><span class='fa fa-thumbs-down'></span>TAF<span class="badge badge-info"><?php echo $f4['total']?></span></li>
											<li class="list-group-item"><span class='fa fa-times'></span>PTOU<span class="badge badge-info"><?php echo $f5['total']?></span></li>
											<li class="list-group-item"><span class='fa fa-reply'></span>Transfer-In<span class="badge badge-info"><?php echo $f6['total']?></span></li>
										</ul>                                
									</div>
								</div>
								<div class="panel panel-primary">
	...
	$conn = new mysqli('localhost', 'root', '', 'thesis') or die(mysqli_error());
										...
										?>
										<ul class="list-group border-bottom">
											<li class="list-group-item"><span class='fa fa-search-plus'></span>Pulmonary<span class="badge badge-info"><?php echo $f1['total']?></span></li>
											<li class="list-group-item"><span class='fa fa-search-minus'></span>Extra-pulmonary<span class="badge badge-info"><?php echo $f2['total']?></span></li>
										</ul>                                
									</div>
								</div>
							</div>
	...
	$conn = new mysqli('localhost', 'root', '', 'thesis') or die(mysqli_error());
										...
										?>
										<ul class="list-group border-bottom">
											<li class="list-group-item"><span class='fa fa-map-marker'></span>Public Health Center<span class="badge badge-info"><?php echo $f1['total']?></span></li>
											<li class="list-group-item"><span class='fa fa-building-o'></span>Private Hospitals<span class="badge badge-info"><?php echo $f2['total']?></span></li>
											<li class="list-group-item"><span class='fa fa-building'></span>Community<span class="badge badge-info"><?php echo $f3['total']?></span></li>
											<li class="list-group-item"><span class='fa fa-home'></span>Other Government Facilities<span class="badge badge-info"><?php echo $f4['total']?></span></li>
										</ul>                                
									</div>
								</div>
							</div>
