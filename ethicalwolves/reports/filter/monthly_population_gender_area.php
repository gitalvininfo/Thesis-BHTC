...
<html lang="en">
	<head>        
		...
		<?php require '../../js/loadchart/filter/patient_gender_area.php'?>
		<style type="text/css">
			@media print {
				#print{
	...
	$query = $conn->query("SELECT * FROM `user` WHERE `user_id` = $_SESSION[user_id]") or die(mysqli_error());
								...
								<div class="pull-left">
									<div class="btn-group" id="print">
										...
										<ul class="dropdown-menu" role="menu">
											...
											<li><a href="#" onclick="oAre()">Staked Area Graph</a></li>
										</ul>
									</div>
		...
		<script>
			...
			function oAre() {
				window.location="monthly_population_gender_area.php?year=<?php echo $year?>";
			}
		</script>
		<script>
