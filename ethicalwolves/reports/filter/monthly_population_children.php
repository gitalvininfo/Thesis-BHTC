				...
				<div class="col-md-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<h3 class="panel-title"> <strong>Adult and Children Registration</strong> <span style="font-size:12px"><i>- as of <?php echo date('F j, Y', strtotime("+8 HOURS"));?></i></span></h3>
						...
						<div class="row">
							<div class="panel-body">
								<div class="col-md-12">
									...
									<div id="ptype" style="width: 100%; height: 400px"></div>
