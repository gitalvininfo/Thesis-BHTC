										...
										<div class="row">
											<div class="col-md-3">
												<div class="tile tile-success">
													<div class="widget-big-int counter" data-count="<?php echo $fetch1['total']?>"><span class="num-count">0</span></div> 
													<p>Public Health Center</p>
												</div>                        
											</div>
											<div class="col-md-3">
												<div class="tile tile-info">
													<div class="widget-big-int counter" data-count="<?php echo $fetch2['total']?>"><span class="num-count">0</span></div> 
