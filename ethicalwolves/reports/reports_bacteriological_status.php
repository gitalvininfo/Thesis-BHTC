                                    ...
                                    <div class="tab-pane active" id="tab-first">
                                        <div class="row">
                                            <div class="panel-heading">
                                                <h3 class="panel-title"><strong> <span class="fa fa-pie-chart"></span> Patient Bacteriological Status</strong></h3>
        ...
        echo $value;
                                       ...
                                       echo date('Y');
                                            ...
                                            <div class="panel-body">
                                                <div id="bacteriological_status" style="width: 100%; height: 400px"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
