        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><strong><mark><?php echo "DST Year ". $year?></mark></strong></li>
                </ul>
                                ...
                                <div class="panel-body tab-content">
                                    ...
                                    <div class="tab-pane" id="tab-second">
                                        <div class="panel-body list-group list-group-contacts scroll" style="height: 410px;">
                                            <?php require 'require/2ndtab_dst_report.php'?>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            $(document).ready(function(){
                $("#pyear").on('change', function(){
                    var year=$(this).val();
                    window.location = 'medtech_reports_dst.php?year='+year;
                });
            });
        </script>
