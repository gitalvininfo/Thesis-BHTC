...
$q3 = $conn->query("select count(*) as total from `patient_ipt`, `registration_ipt` where registration_ipt.patient_id = patient_ipt.patient_id && patient_ipt.status = 'Registered' && registration_ipt.year = '$year'") or die(mysqli_error());
$f3 = $q3->fetch_array();
