<div class="modal fade" id="bc" tabindex="-1" role="dialog" aria-labelledby="largeModalHead" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="largeModalHead"><span class="fa fa-stethoscope"></span> Bacteriological Status - Bacteriologically Confirmed | <strong> Year <?php echo $year?></strong></h4>
                    </div>
    ...
    require '../config.php';
                                    ...
                                    <tr>
                                        <td>
                                            <center>
                                                <?php echo $year. "-". "080". "-" .$fetch['patient_id']?>
                                            </center>
                                        </td>
                                        <td>
                                            <center>
