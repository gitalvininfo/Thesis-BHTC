...
if(ISSET($_POST['add_laboratory_request'])){
    ...
    $conn->query("INSERT INTO `laboratory_request` VALUES('', '$collection_unit', '$date_of_request', '$requesting_physician', '$reason_for_examination', '$specimen_type', '$repeat_collection', '$date_sample_collected', '$date_sample_collected2', '$sample_collector', '$designation', '$test_requested', '$patient_id', 'Pending', '$year')") or die(mysqli_error());
    $conn->close();
