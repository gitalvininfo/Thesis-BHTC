...
<html lang="en">
	...
	$month = date("M", strtotime("+8 HOURS"));
										...
										require 'config.php';
										$query = $conn->query("SELECT * FROM `follow_up`, `patient`, `registration` where patient.patient_id = follow_up.patient_id && patient.patient_id = registration.patient_id && patient.status = 'Registered' && DATE_FORMAT(follow_up_date, '%b') = '$month' group by patient_name") or die(mysqli_error());
