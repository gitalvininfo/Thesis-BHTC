$(function(){        
    ...
    Morris.Area({
        ...
        data: [
            { y: '2005-2006', a: 17,b: 19},
            { y: '2007-2008', a: 19,b: 21},
            { y: '2009-2009', a: 22,b: 25},
            { y: '2010-2011', a: 20,b: 22},
            { y: '2012-2013', a: 21,b: 24},
            { y: '2014-2015', a: 34,b: 37},
            { y: '2016-2017', a: 43,b: 45}
        ],
        xkey: 'y',
        ykeys: ['a','b'],
        labels: ['Sales','Event'],
