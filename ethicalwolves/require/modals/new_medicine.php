...
<div class="modal fade" id="new_medicine" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" class="form-horizontal" action="medicine_table.php" method="post" onsubmit="return confirm('Are you sure you want to add this new medicine?');">
                <div class="modal-body">
                    <div class="panel-body">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-md-8 col-xs-12">
                                <input data-toggle="tooltip" data-placement="bottom" title="Medicine Description" type="text" class="form-control" name="medicine_description" placeholder="Medicine Description"/>
                            </div>
                        </div>
                    </div>
                </div>
