    ...
    <div class="col-md-9">
        <div class="panel-body">
            <div class="tocify-content">
                <h2> <strong>TB Case No: <?php echo $fetch2['year']. "080" .$fetch2['tb_case_no']?></strong></h2><hr>
                <h4>Overview</h4>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-5">                                                
                ...
                <div class="btn-group pull-right">
                    <div class="pull-left">
                        <a href="print/dssm.php?id=<?php echo $fetch['patient_id']?>&patient_name=<?php echo $fetch['patient_name']?>" class="btn btn-default btn-sm">Print</a>
                    </div>
                </div>
                <h4>Results</h4>
